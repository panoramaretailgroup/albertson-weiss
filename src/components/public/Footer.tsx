    ...
    <footer className="bg-black border-t border-white/[0.06] px-6 pt-[72px] pb-10 sm:px-10 lg:px-[88px]">
      <div className="mx-auto max-w-shell">
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          {/* Brand block */}
          <div className="max-w-[320px] flex flex-col items-center lg:items-start">
            <Logo variant="dark" />
            <p className="mt-6 font-sans font-light text-[12px] leading-[1.8] tracking-[0.02em] text-muted text-center lg:text-left">
