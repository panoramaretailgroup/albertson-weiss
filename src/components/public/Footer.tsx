    ...
    <footer className="bg-black border-t border-white/[0.06] px-6 pt-[72px] pb-10 sm:px-10 lg:px-[88px]">
      <div className="mx-auto max-w-shell">
        ...
        <div className="flex flex-col items-center mb-16">
          <Logo variant="dark" />
          <p className="mt-6 max-w-[320px] font-sans font-light text-[12px] leading-[1.8] tracking-[0.02em] text-muted text-center">
        ...
        {/* Columns — centered */}
        <div className="flex flex-wrap justify-center gap-12 lg:gap-20 mb-16">
          {columns.map((col) => (
            <div key={col.title}>
